...
namespace Engine.cgimin.material.gui
{
    public class GUIMaterial : BaseMaterial
    {
        ...
        public GUIMaterial()
        {
            ...
            CreateShaderProgram(MATERIAL_DIRECTORY + "gui/GUI_VS.glsl",
                                MATERIAL_DIRECTORY + "gui/GUI_FS.glsl");
        ...
        public void Draw(BaseObject3D object3d, Matrix4 transformation, int textureID, float alpha, BlendingFactorSrc sourceBlendFunc = BlendingFactorSrc.SrcAlpha, BlendingFactorDest destBlendFunc = BlendingFactorDest.OneMinusSrcAlpha)
        {
