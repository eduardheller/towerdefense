...
namespace Engine.cgimin.material.wobble3
{
    public class Wobble3Material : BaseMaterial
    {
        ...
        public Wobble3Material()
        {

            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram(MATERIAL_DIRECTORY + "wobble3/Wobble3_VS.glsl",
                                MATERIAL_DIRECTORY + "wobble3/Wobble3_FS.glsl");
