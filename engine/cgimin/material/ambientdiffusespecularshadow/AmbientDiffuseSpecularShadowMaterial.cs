...
namespace Engine.cgimin.material.ambientdiffusespecularshadow
{
    public class AmbientDiffuseSpecularShadowMaterial : BaseMaterial
    {
        ...
        public AmbientDiffuseSpecularShadowMaterial()
        {
            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram(MATERIAL_DIRECTORY + "ambientdiffusespecularshadow/AmbientDiffuseSpecularShadow_VS.glsl",
                                MATERIAL_DIRECTORY + "ambientdiffusespecularshadow/AmbientDiffuseSpecularShadow_FS.glsl");
        ...
        public void Draw(BaseObject3D object3d, Matrix4 transform, int textureID, int normalTextureID, float shininess)
        {
            ...
            // Die Projektion der Tiefen-Textur für den Schatten
            // "depthBias" sorgt dafür, dass der 3D-Koordinatenraum (-1 -> 1) umgerechnet wird auf die Koordinaten der Textur (0 -> 1) 
            Matrix4 depthMVP = transform * ShadowMapping.ShadowTransformation * ShadowMapping.DepthBias * ShadowMapping.ShadowProjection;
            GL.UniformMatrix4(DepthBiasMVPLocation, false, ref depthMVP);
