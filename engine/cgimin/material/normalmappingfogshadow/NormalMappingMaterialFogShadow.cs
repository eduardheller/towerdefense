...
namespace Engine.cgimin.material.normalmappingfogshadow
{
    public class NormalMappingMaterialFogShadow : BaseMaterial
    {
        ...
        public NormalMappingMaterialFogShadow()
        {
            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram(MATERIAL_DIRECTORY + "normalmappingfogshadow/NormalMappingFogShadow_VS.glsl",
                                MATERIAL_DIRECTORY + "normalmappingfogshadow/NormalMappingFogShadow_FS.glsl");
