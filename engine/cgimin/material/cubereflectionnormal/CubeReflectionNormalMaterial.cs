...
namespace Engine.cgimin.material.cubereflectionnormal
{
    public class CubeReflectionNormalMaterial : BaseMaterial
    {
        ...
        public CubeReflectionNormalMaterial()
        {
            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram(MATERIAL_DIRECTORY + "cubereflectionnormal/CubeReflectionNormal_VS.glsl",
                                MATERIAL_DIRECTORY + "cubereflectionnormal/CubeReflectionNormal_FS.glsl");
