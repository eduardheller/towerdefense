...
namespace Engine.cgimin.material.normalmappingfog
{
    public class NormalMappingMaterialFog : BaseMaterial
    {
        ...
        public NormalMappingMaterialFog()
        {
            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram(MATERIAL_DIRECTORY + "normalmappingfog/NormalMappingFog_VS.glsl",
                                MATERIAL_DIRECTORY + "normalmappingfog/NormalMappingFog_FS.glsl");
