...
namespace Engine.cgimin.material.normalmapping
{
    public class NormalMappingMaterial : BaseMaterial
    {
        ...
        public NormalMappingMaterial()
        {
            ...
            CreateShaderProgram(MATERIAL_DIRECTORY + "normalmapping/NormalMapping_VS.glsl",
                                MATERIAL_DIRECTORY + "normalmapping/NormalMapping_FS.glsl");
