...
namespace Engine.cgimin.material.normalmappingshadowinstanced
{
    public class NormalMappingShadowInstancedMaterial : BaseMaterial
    {
        ...
        public NormalMappingShadowInstancedMaterial()
        {
            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram(MATERIAL_DIRECTORY + "normalmappingshadowinstanced/NormalMappingShadowInstanced_VS.glsl",
                                MATERIAL_DIRECTORY + "normalmappingshadowinstanced/NormalMappingShadowInstanced_FS.glsl");
            ...
            GL.BindAttribLocation(Program, 5, "in_offsetposition");
        ...
        public void Draw(BaseObject3D object3d, int count, int textureID, int normalTextureID, float shininess)
        {
            ...
            // Die Projektion der Tiefen-Textur für den Schatten
            // "depthBias" sorgt dafür, dass der 3D-Koordinatenraum (-1 -> 1) umgerechnet wird auf die Koordinaten der Textur (0 -> 1) 
            Matrix4 depthMVP = ShadowMapping.ShadowTransformation * ShadowMapping.DepthBias * ShadowMapping.ShadowProjection;
            GL.UniformMatrix4(DepthBiasMVPLocation, false, ref depthMVP);
