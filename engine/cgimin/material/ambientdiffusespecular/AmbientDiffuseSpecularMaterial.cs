...
namespace Engine.cgimin.material.ambientdiffusespecular
{
    public class AmbientDiffuseSpecularMaterial : BaseMaterial
    {
        ...
        public AmbientDiffuseSpecularMaterial()
        {
            ...
            CreateShaderProgram(MATERIAL_DIRECTORY + "ambientdiffusespecular/AmbientDiffuseSpecular_VS.glsl",
                                MATERIAL_DIRECTORY + "ambientdiffusespecular/AmbientDiffuseSpecular_FS.glsl");
        ...
        public void Draw(BaseObject3D object3d, Matrix4 transform, int textureID, float shininess)
        {
            // Textur wird "gebunden"
            GL.BindTexture(TextureTarget.Texture2D, textureID);
