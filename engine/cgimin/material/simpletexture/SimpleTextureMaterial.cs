...
namespace Engine.cgimin.material.simpletexture
{
    public class SimpleTextureMaterial : BaseMaterial
    {
        ...
        public SimpleTextureMaterial()
        {
            ...
            CreateShaderProgram(MATERIAL_DIRECTORY + "simpletexture/Simple_VS.glsl",
                                MATERIAL_DIRECTORY + "simpletexture/Simple_FS.glsl");
        ...
        public void Draw(BaseObject3D object3d, Matrix4 transformation, int textureID)
        {
