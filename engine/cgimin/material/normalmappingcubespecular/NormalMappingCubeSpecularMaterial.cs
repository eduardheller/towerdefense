...
namespace Engine.cgimin.material.normalmappingcubespecular
{
    public class NormalMappingCubeSpecularMaterial : BaseMaterial
    {
        ...
        public NormalMappingCubeSpecularMaterial()
        {
            ...
            CreateShaderProgram(MATERIAL_DIRECTORY + "normalmappingcubespecular/NormalMappingCubeSpecular_VS.glsl",
                                MATERIAL_DIRECTORY + "normalmappingcubespecular/NormalMappingCubeSpecular_FS.glsl");
