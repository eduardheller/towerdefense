...
namespace Engine.cgimin.material.cubereflectionfogcascaded
{
    public class CubeReflectionFogCascaded : BaseMaterial
    {
        ...
        public CubeReflectionFogCascaded()
        {
            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram(MATERIAL_DIRECTORY + "cubereflectionfogcascaded/CubeReflectionFogCascaded_VS.glsl",
                                MATERIAL_DIRECTORY + "cubereflectionfogcascaded/CubeReflectionFogCascaded_FS.glsl");
