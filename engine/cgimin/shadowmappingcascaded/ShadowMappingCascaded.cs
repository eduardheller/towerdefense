...
namespace Engine.cgimin.shadowmappingcascaded
{
    public class ShadowMappingCascaded
    {
        ...
        public static void SetDepthTextureTarget(int target)
        {
            ...
            Camera.SetTransformMatrix(Matrix4.LookAt(textCamPosition, textCamPosition - Light.lightDirection, new Vector3(0, 1, 0)));
