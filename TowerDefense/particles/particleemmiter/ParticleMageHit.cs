...
{
    class ParticleMageHit : ParticleSystem
    {
        public ParticleMageHit(ParticleAtlas textureAtlas, float pps, float speed, float gravity, float lifetime) : 
        ...
        public override void EmitParticle(FrameEventArgs e, Vector3 position, Vector3 velocity)
        {
            ...
            ParticleRenderer.AddParticle(new Particle(new Vector3(position), vel, TextureAtlas, Gravity, Lifetime, rot, 1.5f));
        }
    }
}
